...
# a script for using ia's archive-metadata-extractor.jar
...
cmd=$1
dir=$2
# works: hadoop dfs -ls hdfs://master:8020/user/rainer/warcs/WEB-20130125064209488-00014-31940~s3scape01~8083.warc.gz
